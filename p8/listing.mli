...
(* from0to n = [0; 1; 2; ... ; n]
   provoca una excepción Failure si n < 0 *)
...
(* remove x l devuelve una lista como la l,
...
(* remove_duplicates l devuelve una lista como la l,
   pero donde cada elemento aparece sólo una vez,
   es decir, no hay elementos repetidos *)

val ldif : 'a list -> 'a list -> 'a list
(* ldif l1 l2 devuelve una lista como la l1,
   pero de la que han desaparecido todas las apariciones
   de los valores que aparecen en l2 *)
